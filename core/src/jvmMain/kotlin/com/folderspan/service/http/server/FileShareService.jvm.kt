...
actual suspend fun startFileShareService() {
    if (!fileShareServiceStartingOrRunning.compareAndSet(false, true)) {
        LogKit.i(AppStrings.ui_file_share_https_service_already_running_skipping_repeated_startup)
        return
    }
    ...
    try {
        ...
        try {
            ...
            LogKit.e(AppStrings.ui_file_share_raw_tls_service_startup_failed_jvm_arg0.format(arg0 = message), error)
