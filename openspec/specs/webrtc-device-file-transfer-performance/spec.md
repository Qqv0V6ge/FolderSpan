# webrtc-device-file-transfer-performance Specification

## Purpose
TBD - created by archiving change update-webrtc-device-transfer-throughput. Update Purpose after archive.
## Requirements
